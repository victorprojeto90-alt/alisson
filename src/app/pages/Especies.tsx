...
const BANCO_ESPECIES: Especie[] = [
  ...
  { nome_popular: 'Craibeira', nome_cientifico: 'Tabebuia aurea', familia: 'Bignoniaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Inicial' },
  { nome_popular: 'Pau-d\'arco', nome_cientifico: 'Handroanthus impetiginosus', familia: 'Bignoniaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  { nome_popular: 'Quixabeira', nome_cientifico: 'Sideroxylon obtusifolium', familia: 'Sapotaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  { nome_popular: 'Feijão-bravo', nome_cientifico: 'Capparis flexuosa', familia: 'Capparaceae', bioma: 'caatinga', grupo_sucessional: 'Pioneira' },
  { nome_popular: 'Icó', nome_cientifico: 'Capparis yco', familia: 'Capparaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Inicial' },
  { nome_popular: 'Pau-ferro', nome_cientifico: 'Libidibia ferrea', familia: 'Fabaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  { nome_popular: 'Mororó', nome_cientifico: 'Bauhinia cheilantha', familia: 'Fabaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Inicial' },
  { nome_popular: 'Facheiro', nome_cientifico: 'Pilosocereus pachycladus', familia: 'Cactaceae', bioma: 'caatinga', grupo_sucessional: 'Pioneira' },
  { nome_popular: 'Coroa-de-frade', nome_cientifico: 'Melocactus zehntneri', familia: 'Cactaceae', bioma: 'caatinga', grupo_sucessional: 'Pioneira' },
  { nome_popular: 'Cumaru da Caatinga', nome_cientifico: 'Amburana cearensis', familia: 'Fabaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  { nome_popular: 'Cássia', nome_cientifico: 'Senna spectabilis', familia: 'Fabaceae', bioma: 'caatinga', grupo_sucessional: 'Pioneira' },
  { nome_popular: 'Baraúna-branca', nome_cientifico: 'Cordia oncocalyx', familia: 'Boraginaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  { nome_popular: 'Umburana-de-cheiro', nome_cientifico: 'Commiphora leptophloeos', familia: 'Burseraceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Inicial' },
  { nome_popular: 'Tamboril', nome_cientifico: 'Enterolobium contortisiliquum', familia: 'Fabaceae', bioma: 'caatinga', grupo_sucessional: 'Secundária Tardia' },
  // Cerrado
