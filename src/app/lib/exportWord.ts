  ...
  const children: (Paragraph | Table)[] = [
    ...
    simpleTable(
      ...
      [
        ...
        ['IC por Parcela (m³/parcela)', `${dg.ic_inferior_parcela.toFixed(4)} ≤ ${dg.media_vol_parcela.toFixed(4)} ≤ ${dg.ic_superior_parcela.toFixed(4)}`],
        ['IC por Hectare (m³/ha)', `${dg.ic_inferior_ha.toFixed(4)} ≤ ${dg.media_vol_ha.toFixed(4)} ≤ ${dg.ic_superior_ha.toFixed(4)}`],
        ['IC da População (m³)', `${dg.ic_inferior_pop.toFixed(2)} ≤ ${dg.volume_estimado_total.toFixed(2)} ≤ ${dg.ic_superior_pop.toFixed(2)}`],
