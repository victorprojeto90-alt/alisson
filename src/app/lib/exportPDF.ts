...
export function exportarPDF(
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ['Média de Volume (m³/ha)', dg.media_vol_ha.toFixed(4)],
      ['Variância Amostral', dg.variancia_amostral.toFixed(6)],
      ['Desvio Padrão (s)', dg.desvio_padrao.toFixed(4)],
      ...
      ['Erro Amostral Absoluto (m³/ha)', dg.erro_abs.toFixed(4)],
      ['Erro Amostral Relativo (%)', `${dg.erro_rel_pct.toFixed(2)}%`],
      ['IC Inferior — por Hectare (m³/ha)', dg.ic_inferior_ha.toFixed(4)],
      ['IC Superior — por Hectare (m³/ha)', dg.ic_superior_ha.toFixed(4)],
      ['IC Inferior — População (m³)', dg.ic_inferior_pop.toFixed(2)],
      ['IC Superior — População (m³)', dg.ic_superior_pop.toFixed(2)],
